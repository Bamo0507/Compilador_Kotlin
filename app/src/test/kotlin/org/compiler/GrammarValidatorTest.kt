...
class GrammarValidatorTest {
    ...
    // Derived from the real lexical spec so this test always validates the actual
    // parser_test.yal / parser.yalp pairing instead of a hardcoded copy that drifts.
    private val javaLexerCategories: Set<String> =
        YalexReader.parse(File("src/main/resources/parser_test.yal").readText())
