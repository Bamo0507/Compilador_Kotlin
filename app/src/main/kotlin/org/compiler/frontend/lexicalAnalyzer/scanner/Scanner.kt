package org.compiler.frontend.lexicalAnalyzer.scanner
...
// Walks a consumed string and returns the (line, position) that the next char would have.
// Each '\n' increments line and resets position to 1; any other char increments position.
fun advanceLineAndPosition(line: Int, position: Int, consumed: String): Pair<Int, Int> {
    var newLine = line
