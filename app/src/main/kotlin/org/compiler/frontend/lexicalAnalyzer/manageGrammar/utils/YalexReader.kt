...
import org.compiler.frontend.lexicalAnalyzer.manageGrammar.models.RegexMapping
import java.io.File
import kotlin.collections.iterator

object YalexReader {
    fun read(filePath: String): List<RegexMapping> = parse(File(filePath).readText())

    fun parse(content: String): List<RegexMapping> {
