...
class TypeRulesTest {
    ...
    // W2: la precondicion esta verificada. Sin el require, esto devolveria
    // IntegerType en silencio.
    @Test
    ...
    // ── La razon de que TypeRules sea clase y no object ────────────────────

    // Dos instancias con jerarquias distintas responden distinto: la jerarquia es
    // estado INYECTADO, no global. Con un `object` este test seria imposible.
    @Test
